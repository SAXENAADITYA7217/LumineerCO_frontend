...
const SidebarLinks = ({ isMobile }) => {
    ...
    return (
        <div className="d-flex flex-column gap-2">
            <NavLink to="/user-dashboard" end className={({ isActive }) => getLinkClass(isActive)} onClick={handleLinkClick}>
                <span className="fs-5">📊</span> Dashboard
            </NavLink>

            <NavLink to="/user-dashboard/new-request" className={({ isActive }) => getLinkClass(isActive)} onClick={handleLinkClick}>
                <span className="fs-5">➕</span> New Request
            </NavLink>

            <NavLink to="/user-dashboard/all-requests" className={({ isActive }) => getLinkClass(isActive)} onClick={handleLinkClick}>
                <span className="fs-5">📋</span> All Requests
            </NavLink>

            <NavLink to="/user-dashboard/warranty-requests" className={({ isActive }) => getLinkClass(isActive)} onClick={handleLinkClick}>
                <span className="fs-5">🛡️</span> Warranty Requests
            </NavLink>

            <NavLink to="/user-dashboard/rejected-requests" className={({ isActive }) => getLinkClass(isActive, "danger")} onClick={handleLinkClick}>
